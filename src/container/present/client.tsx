...
//               <CheckPresentItem presentId={Number(presentId)} giverName={methods.watch('name')} />
//               <Image
...
//       {presentStep === 'payment' && (
//         <Button onClick={handleGivePresent} styles={{ marginBottom: '5.8rem' }}>
//           {'선물하러 가기'}
//         </Button>
//       )}
//     </>
...
// }) {
//   return (
//     <Button onClick={handleClick} styles={{ marginBottom: '5.8rem' }} disabled={disabled}>
//       {'친구 생일 축하해주기'}
//     </Button>
//   );
// }
