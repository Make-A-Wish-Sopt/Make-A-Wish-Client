...
export const WishesHistoryPageContainer = ({
  wishesHistory,
  children,
        ...
        <>
          ...
          <Modal
            ...
            Trigger={
              <Image
                onClick={() => {
                  selectedIdArray.length > 0 && openModal('deleteWish');
                }}
                src={DeleteBtnIc}
                alt="삭제 아이콘"
                width={44}
          ...
          >
            <ConfirmModalContent
              contentTitle={`총${selectedIdArray.length}개의 생일잔치 링크를\n삭제하시겠어요?`}
            >
