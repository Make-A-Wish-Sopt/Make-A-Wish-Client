...
import {
  ...
  WishesLinkDataType,
} from '@/types/wishes/create/wishesCreateDataType';
    ...
    <>
      ...
      <InputForm title="생일 선물도 받고 싶어요!">
        <ul className="flex flex-col gap-12">
          ...
          >
            <DropDwonBox isOpen={isOpen} handleToggle={handleToggle}>
                ...
                <div className="flex w-full flex-wrap gap-5 justify-between">
                  {presentList.map((item) => (
                    ...
                    >
                      ...
                      <span className="font-bitbit text-white text-[12px]">{item.itemName}</span>
      ...
      <div className="h-50 text-white mb-58">
        <Button
          bgColor="main_blue"
          fontColor="white"
