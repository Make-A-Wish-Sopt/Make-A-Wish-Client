...
import { DetailOpenIc } from '@/public/assets/icons';
import { DetailCloseIc } from '@/public/assets/icons';
  ...
  return (
    <Styled.Container>
      ...
      <Styled.Background2>
        ...
        <Styled.Content>
          <Styled.About>
            '조물주보다 생일선물주'는 카카오페이 결제<br />서비스를 연동하여 펀딩 총 금액의 3.4%를<br />수수료를 받고 있습니다.<br />펀딩액 정산 시 차감되어 입금됩니다.
          </Styled.About>

          <Styled.DetailButton onClick={handleToggle}>
            {isHidden ? <Image src={DetailOpenIc} alt="자세히 보기" /> : <Image src={DetailCloseIc} alt="닫기" />}
          </Styled.DetailButton>
          {!isHidden && (
            <Styled.AboutDetail>
              '조물주보다 생일선물주’는 사용자분들의 편리한<br />결제를 위해 카카오페이 결제를 연동하였습니다.<br />이에 해당 서비스는 카카오페이 가맹점으로 다음과<br />같은 수수료 정책을 적용 받고 있습니다.<br /><br />1. 서비스 이용 수수료란, 카카오 페이구매 시<br />상품주문건별로 부과되는 수수료 입니다.<br />2. 카카오페이 서비스 독립몰의 수수료는 최대 <br />3.4%가 적용됩니다.<br />※ 수수료는 부가세가 포함된 비율입니다.
            </Styled.AboutDetail>
          )}
