...
import Modal from '@/components/ommon/modal';
import DeleteModal from '@/components/ommon/modal/DeleteModal';
import { useState } from 'react';
import WishLists from './ishLists';
import NoWishLists from './oWishLists';
